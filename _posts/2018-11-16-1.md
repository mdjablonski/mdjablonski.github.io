...
{% include standard-figure.html path="/images/pirx-autosearch.gif" description="" caption="Autosearch & Favorites — the most convenient way to use the receiver." %}
...
{% include standard-figure.html path="/images/pirx-manual.gif" description="" caption="Manual Tune — frequency graph and tuning." %}
...
{% include standard-figure.html path="/images/pirx-leds.gif" description="" caption="🎵 Shine bright like a diamond 💎" %}
